...
// Call the funtion to run and display the countdown clock
runClock();
...
function runClock() {
   ...
   //Calculate the days until the next Janurary 1st
   ...
   //Calculate the minutes and the seconds left in the current hour
